...
authors:
  - name: "sunzhongkai"
stance: "2026 年的 coding agent 检索不会是 grep 或向量索引二选一，而会走向可验证、低噪声的 Hybrid Search。"
...
| **Code Intelligence** | 用代码地图、语言服务器协议（LSP）、抽象语法树（AST）、符号图谱补上结构化导航 | Aider、Claude Code LSP、OpenCode LSP |
...
这五类不是互斥关系。我判断 2026 年的趋势是 Hybrid Search，原因不是向量数据库“更先进”，也不是 grep “赢了”。更准确地说，公开材料里有几条信号正在同时出现：
...
<div class="mermaid">flowchart TB
  ...
  classDef agent fill:#f5f3ff,stroke:#7c3aed,color:#312e81;</div>
...
<div class="mermaid">flowchart TB
  ...
  classDef bad fill:#fef2f2,stroke:#ef4444,color:#7f1d1d;</div>
...
<div class="mermaid">flowchart TB
  ...
  classDef done fill:#f0fdf4,stroke:#22c55e,color:#14532d;</div>
...
<div class="mermaid">flowchart TB
  ...
  classDef tool fill:#ecfeff,stroke:#0891b2,color:#164e63;
  classDef context fill:#f0fdf4,stroke:#22c55e,color:#14532d;
  classDef done fill:#eef2ff,stroke:#6366f1,color:#312e81;</div>
...
<div class="mermaid">flowchart TB
  ...
  classDef agent fill:#f5f3ff,stroke:#7c3aed,color:#312e81;
  classDef tool fill:#ecfeff,stroke:#0891b2,color:#164e63;
  classDef context fill:#f0fdf4,stroke:#22c55e,color:#14532d;</div>
...
- **默认会变成 Hybrid Search。** grep、semantic index、LSP、代码地图、记忆、工具检索都会存在，harness 负责路由。
